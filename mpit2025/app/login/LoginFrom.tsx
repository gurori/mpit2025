...
export default function LoginFrom() {
    ...
    const {register, handleSubmit, formState: {errors}} = useForm<TypeFormData>({resolver: zodResolver(userSchema)});
    ...
    return <form className="grid gap-2 mt-6" onSubmit={handleSubmit(onSubmit)}>
